	...
	<div class="col-md-6 p-0 divider-right">
		...
		<div class="py-4">
			...
			<ul class="nav nav-tabs pl-4" id="badgestabs" role="tablist">
		        <li class="nav-item">
		          <a class="nav-link active" id="avalanche-badges-tab" data-toggle="tab" href="#avalanche-badges" role="tab" aria-controls="avalanche-badges" aria-selected="true"><?=SITE_CONFIG["site"]["name"]?> Badges</a>
		        </li>
		        <li class="nav-item">
		    ...
		    <div class="tab-content pt-4 pl-4" id="badgestabsContent">
		        <div class="tab-pane active" id="avalanche-badges" role="tabpanel" aria-labelledby="avalanche-badges-tab">
		        	<div class="row avalanche-badges-pane">
			  		</div>
		        </div>
...
<script>
	...
	{ 
		...
		loadBadges(<?=$userid?>, <?=$selfProfile?'true':'false'?>, "avalanche-badges", 1);
