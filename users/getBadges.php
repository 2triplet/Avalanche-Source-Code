...
if(!in_array($_GET['type'], ["user-badges", "avalanche-badges"])){ api::respond(400, false, "Invalid Request - invalid badge type"); }
...
{  
	...
	$responsemsg .= $_GET['type'] == "user-badges" ? " player-made badges" : " avalanche badges";
}
else
{
	$responsemsg = $badges;
