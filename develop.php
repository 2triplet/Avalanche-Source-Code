...
{
	$errors["type"] = "shirts";
	if(!isset($_POST["avalanche-csrf"]) || isset($_POST["avalanche-csrf"]) && $_POST["avalanche-csrf"] != SESSION["csrfToken"])
	{
		  	...
		  	<div class="px-4">
			  	...
			  	<form method="post" enctype="multipart/form-data">
					...
					<div class="form-group mb-2">
						...
						<div class="col-sm-8">
							<input type="hidden" name="avalanche-csrf" value="<?=SESSION["csrfToken"]?>">
